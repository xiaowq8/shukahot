<template>
  <div class="mine_bg">
    ...
    <div class="all-container-padding bg" >
     ...
     <el-tab-pane label="基本信息" name="first" class="informatian">
      ...
      <div class="grid-content bg-purple">
       <el-button type="success" plain @click="EditorUserClick('userlist')" >保存</el-button>
      </div>
     </el-tab-pane>
     <el-tab-pane label="修改密码" name="second"  class="informatian">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
       <el-form-item label="原密码" prop="pass" :label-width="formLabelWidth">
        ...
        <div class="grid-content bg-purple">
       <el-button type="success" plain @click="submitForm('ruleForm')">保存</el-button>
      </div>
     </el-tab-pane>
    </el-tabs>
    </div>
